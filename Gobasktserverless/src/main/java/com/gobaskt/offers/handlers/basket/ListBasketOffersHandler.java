 ...
 * for get list of basket offers
 * 
 * */
public class ListBasketOffersHandler {
	...
	public APIGatewayProxyResponseEvent listTasks(APIGatewayProxyRequestEvent request, Context context) throws JsonProcessingException {

		List<BasketActivity> tasks = this.getBasketService().getBasket();
		if (tasks.isEmpty()) {
